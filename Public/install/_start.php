...
<div class="radius bg bouncein window window_small" >
    ...
    <div class="padding-large text-black">
        ...
        <div class="input padding bg-white" style="width: 100%;height: 200px; overflow: auto">
                ...
                <p>PhalApi官方网站为 <a href="http://www.phalapi.net，依法独立拥有">http://www.phalapi.net，依法独立拥有</a> PhalApi 及官网发布的PhalApi衍生产品著作权。PhalApi及其衍生产品著作权受到法律和国际公约保护。使用者需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 PhalApi及其衍生 软件。  </p>
