...
在此借一行文字的空间，感谢 **开源中国** 这么好的分享平台，同时也感谢您花费宝贵的时间来阅读此文档，谢谢！在开源的路上，您每一次真心的关注和肯定都是我们前进的最大动力！    
...
下篇
    [1.10] 类的自动加载：遵循PEAR包的全名规范
    [1.11] 签名验证：自定义签名规则
    [1.12] 请求和响应：GET和POST两者皆可得及超越JSON格式返回
    [1.13] 缓存策略：更灵活地可配置化的多级缓存
    ...
...
项目实践
    [3.1] 开发实战1：微信服务号开发
    [3.2] 开发实战2：模拟优酷开放平台接口项目开发
    [3.3] 开发实战3：模拟腾讯开放平台接口项目开发
    ...
...
#官网
官网还在努力开发中，感兴趣的同学，可以访问：[www.phalapi.net](http://112.74.107.125/)  ![apic](http://webtools.qiniudn.com/phalapi-logo-2-33.png)  
