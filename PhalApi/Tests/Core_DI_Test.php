<?php
/**
 * PhpUnderControl_CoreDI_Test
 *
 * 针对 ../Core/DI.php Core_DI 类的PHPUnit单元测试
 *
...
if (!class_exists('Core_DI')) {
    require dirname(__FILE__) . '/../Core/DI.php';
}

class PhpUnderControl_CoreDI_Test extends PHPUnit_Framework_TestCase
{
    public $coreDI;
    ...
    {
        $this->coreDI->dogstar = new Core_DI();
    ...
    {
        $this->coreDI->key = 'Core_DI';
        $this->assertInstanceOf('Core_DI', $this->coreDI->key);
    }
